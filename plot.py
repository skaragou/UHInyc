...
def hourly_temp_graph():
	...
	titles = ['Number of Trees within 15m','Mean Floor-Area Ratio','Minimum Distance to Park','Number of Buildings within 50m']
...
def pair_plot():
	sns.pairplot(data[['AirTemp','num_build500','mean_fa_ratio','min_distance_park','num_trees15']])
	plt.show()
